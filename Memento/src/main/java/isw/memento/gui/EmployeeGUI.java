package isw.memento.gui;

import javax.swing.JFrame;
import javax.swing.JOptionPane;
import java.awt.event.ActionEvent;
import isw.memento.entity.Employee;
import isw.memento.impl.EmployeeCareTaker;
import isw.memento.impl.EmployeeMemento;
...
public class EmployeeGUI extends JFrame {
	 Employee employee = new Employee();
	    ...
	    private void previous(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_previous
	        ...
	        if(menento==null){
	            JOptionPane.showMessageDialog(this, "No hay mas estados");
	            return;
	        }
